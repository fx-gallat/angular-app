...
export enum TodoListActionTypes {
  ...
  TodoItemSavedDatabase = '[TodoList] TodoSavedDataBase'
}
...
export class TodoItemSaved implements Action {
  readonly type = TodoListActionTypes.TodoItemSavedDatabase;
...
export class TodoListActions {
  ...
  public saveDataBaseTodo(todoItem : TODOItem): any {
    this.store.dispatch(new TodoItemSaved(todoItem));
  }
